...
class StandardBankCCLoader(AccountCSVLoader):
    ...
    def __init__(self, dirname, filename, accts_dictionary, data):
        ...
        super(StandardBankCCLoader, self).__init__(dirname, filename, accts_dictionary, data)
        self._al_accts = ['Liabilities', 'Standard Bank Credit card']
